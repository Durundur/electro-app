namespace Domain.Aggregates.UserProfileAggregate
{
    public class Recipient
    {
        ...
        public static Recipient Create(Guid userProfileId, RecipientType type, string? firstName, string? surname, string? companyName, string? taxIdentificationNumber, string phoneNumber, string street, string houseNumber, string postalCode, string city)
        {
