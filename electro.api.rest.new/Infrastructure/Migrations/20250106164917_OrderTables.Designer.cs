...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250106164917_OrderTables")]
            ...
            modelBuilder.Entity("Domain.Aggregates.OrderAggregate.Delivery", b =>
                {
                    b.HasOne("Domain.Aggregates.OrderAggregate.Order", null)
                        .WithOne()
                        .HasForeignKey("Domain.Aggregates.OrderAggregate.Delivery", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Aggregates.OrderAggregate.Order", null)
                        .WithOne("Delivery")
                        .HasForeignKey("Domain.Aggregates.OrderAggregate.Delivery", "OrderId1");
            ...
            modelBuilder.Entity("Domain.Aggregates.OrderAggregate.OrderProduct", b =>
                {
                    ...
                    b.HasOne("Domain.Aggregates.ProductCatalogAggregate.Product", null)
                        .WithOne()
                        .HasForeignKey("Domain.Aggregates.OrderAggregate.OrderProduct", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Aggregates.OrderAggregate.Payment", b =>
                {
                    b.HasOne("Domain.Aggregates.OrderAggregate.Order", null)
                        .WithOne()
                        .HasForeignKey("Domain.Aggregates.OrderAggregate.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Aggregates.OrderAggregate.Order", null)
                        .WithOne("Payment")
                        .HasForeignKey("Domain.Aggregates.OrderAggregate.Payment", "OrderId1");
                });
            ...
            modelBuilder.Entity("Domain.Aggregates.OrderAggregate.Recipient", b =>
                {
                    b.HasOne("Domain.Aggregates.OrderAggregate.Order", null)
                        .WithOne()
                        .HasForeignKey("Domain.Aggregates.OrderAggregate.Recipient", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Aggregates.OrderAggregate.Order", null)
                        .WithOne("Recipient")
                        .HasForeignKey("Domain.Aggregates.OrderAggregate.Recipient", "OrderId1");
                });
