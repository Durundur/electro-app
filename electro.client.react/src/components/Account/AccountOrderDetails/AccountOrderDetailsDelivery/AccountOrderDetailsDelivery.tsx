...
interface AccountOrderDetailsDeliveryProps {
	delivery: Delivery;
}

const AccountOrderDetailsDelivery: FC<AccountOrderDetailsDeliveryProps> = ({ delivery }) => {
	return (
		<Stack>
...
export default AccountOrderDetailsDelivery;
