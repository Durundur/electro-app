<template>
	<SubCardTitle>Dane do faktury</SubCardTitle>
	<div class="d-flex flex-column ga-4">
		...
		<v-text-field
			...
			label="Nazwa firmy"></v-text-field>
		<div class="d-flex ga-2 flex-md-row">
			<v-text-field
				class="size-medium"
				variant="outlined"
				rounded="lg"
			...
			<v-text-field
				...
				label="Numer domu lub mieszkania"></v-text-field>
		</div>
		<v-text-field
			class="size-medium"
			variant="outlined"
		...
		<v-text-field
			...
			label="Miejscowość"></v-text-field>
	</div>

	<SubCardTitle>Dane odbiorcy przesyłki</SubCardTitle>
	<div class="d-flex flex-column ga-4">
		<v-text-field
			class="size-medium"
			variant="outlined"
			...
			label="Imię i nazwisko lub nazwa firmy"></v-text-field>
		<v-text-field
			class="size-medium"
			variant="outlined"
			rounded="lg"
