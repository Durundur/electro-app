...
interface AdminOrderDetailsSummaryProps {
	totalCost: Money;
...
const AdminOrderDetailsSummary: FC<AdminOrderDetailsSummaryProps> = ({ deliveryCost, paymentCost, totalProductsCost, totalCost }) => {
	return (
		<Stack spacing={1}>
...
export default AdminOrderDetailsSummary;
